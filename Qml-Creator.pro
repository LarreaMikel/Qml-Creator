...
UBUNTU_TRANSLATION_DOMAIN="qml-creator.larreamikel"
...
aptest.commands = bash $$PWD/Qml-Creator/tests/autopilot/run
aptest.depends  = sub-Qml-Creator

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/Qml-Creator/tests/unit 
unittest.depends  = sub-Qml-Creator
